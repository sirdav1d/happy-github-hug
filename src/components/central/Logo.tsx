      ...
      {customLogoUrl ? (
        ...
        <div className={`
          ...
          ${isThinking
            ...
            : 'bg-gradient-to-r from-indigo-600 via-blue-500 to-cyan-500 border-white/20'
          }
        `}>
          <Cpu
            size={24}
            strokeWidth={1.5}
            className={`transition-all duration-500 ${isThinking ? 'text-white animate-[spin_3s_linear_infinite]' : 'text-white'}`}
          />
        </div>
      )}
